...
export default function BookButton() {
    return (
        ...
        <Link
            role="button"
            className="text-4xl group relative inline-flex items-center justify-center rounded-xl bg-gray-900 px-20 py-8 font-semibold text-white transition-all duration-200 hover:bg-gray-800 hover:shadow-lg hover:-translate-y-0.5 hover:shadow-gray-600/30"
            title="payment"
